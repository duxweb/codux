...
pub(in crate::memory::profile) fn llm_project_profile_fingerprint(
    source_fingerprint: &str,
) -> String {
    format!("llm-v1:{source_fingerprint}")
}

pub(in crate::memory::profile) fn project_profile_llm_source_fingerprint(
    source_fingerprint: &str,
...
pub(in crate::memory::profile) fn project_profile_content_with_memory_context(
    content: &str,
    memory_context: &[String],
) -> String {
...
pub(in crate::memory::profile) fn project_profile_fingerprints_match(
    existing: &str,
    incoming: &str,
) -> bool {
    existing == incoming
...
pub(in crate::memory::profile) fn project_profile_llm_refresh_due(
