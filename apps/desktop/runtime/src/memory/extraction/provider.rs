...
use crate::settings::{AIProviderSettings, AISettings};
...
pub fn ensure_memory_provider_available(settings: &AISettings) -> Result<(), String> {
...
pub fn provider_summary(provider: &AIProviderSettings) -> String {
    format!(
