...
> **为什么 iOS 版收费？** Codux 完全开源（GPL-3.0），桌面端与 Android 版免费。iOS 定价仅用于覆盖苹果每年 99 美元的开发者费用与收入抽成，支持项目持续开发，无订阅、无内购。不想付费？可从 [codux-flutter](https://github.com/duxweb/codux-flutter) 获取源码自行编译，功能完全一致。
