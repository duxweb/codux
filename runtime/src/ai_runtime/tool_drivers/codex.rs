...
pub const DRIVER: AIRuntimeToolDriver = AIRuntimeToolDriver {
    ...
    hook: AIRuntimeToolHookDriver::Json(AIRuntimeJsonHookDriver {
        ...
        definitions: &[
            hook("SessionStart", "codex-session-start", 1000, true),
            hook("UserPromptSubmit", "codex-prompt-submit", 1000, true),
            hook("PermissionRequest", "codex-permission-request", 1000, true),
            hook("Stop", "codex-stop", 1000, true),
        ],
    }),
